...
trying to pull csv file uploaded to git hub
ultimate goal: get the april2022auditdata csv file to be pullable so that the doc will knit
...
```{r read-csv}
april2022auditdata <- read_csv("~/Downloads/april2022auditdata.csv")
